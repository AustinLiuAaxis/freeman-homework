...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'homework';
    ...
    'jhipster.mail.from' = 'homework@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'homework API';
    'jhipster.swagger.description' = 'homework API documentation';
    ...
    'eureka.instance.appname' = 'homework';
    'eureka.instance.instanceId' = 'homework:${random.value}';
